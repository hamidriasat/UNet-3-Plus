...
def UNet_3Plus_DeepSup(INPUT_SHAPE, OUTPUT_CHANNELS):
    filters = [64, 128, 256, 512, 1024]
    ...
    return tf.keras.Model(inputs=input_layer, outputs=[d1, d2, d3, d4, e5], name='UNet_3Plus_DeepSup')

""" UNet_3Plus with Deep Supervison and Classification Guided Module"""

def UNet_3Plus_DeepSup_CGM(INPUT_SHAPE, OUTPUT_CHANNELS):
    filters = [64, 128, 256, 512, 1024]
    ...
    return tf.keras.Model(inputs=input_layer, outputs=[d1, d2, d3, d4, e5, cls], name='UNet_3Plus_DeepSup_CGM')
...
if __name__ == "__main__":
    ...
    unet_3P = UNet_3Plus_DeepSup(INPUT_SHAPE, OUTPUT_CHANNELS)
    unet_3P.summary()
